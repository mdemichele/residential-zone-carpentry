...
function pn_enqueue_style() {
        wp_enqueue_style('theme-styles', get_template_directory_uri() . '/assets/css/rzc-styles.css', array(), microtime(), false);
...
function pn_enqueue_script(){
        ...
        wp_enqueue_script('main-js', get_template_directory_uri() . '/assets/dist/js/rzc-js.dist.js', '', microtime(), true);
        wp_enqueue_script('icons', get_template_directory_uri() . '/assets/vendors/feather-icons/dist/feather.min.js');
